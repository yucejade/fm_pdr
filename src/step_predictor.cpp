...
Eigen::VectorXi CFmStepPredictor::find_real_peak_indices(const Eigen::VectorXd &data,
                                                         int range,
                                                         int min_distance,
...
FeatureMatrix CFmStepPredictor::calculate_features(const Eigen::VectorXi &real_peak_indices,
                                                   const Eigen::VectorXd &filtered_accel_data,
                                                   int start_step_index,
                                                   int end_step_index)
{
...
LinearModel CFmStepPredictor::select_model(const string &model_str,
...
// 步长回归处理函数
LinearModel CFmStepPredictor::step_process_regression(const std::string &model_str,
                                                      int move_average,
                                                      int min_distance,
...
double CFmStepPredictor::step_process_mean(int move_average,
                                           int min_distance,
                                           const std::string &save_model_name,
                                           double &valid_peak_value)
{
