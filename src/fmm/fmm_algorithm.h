...
struct FastMapMatchConfig
{
     ...
     *
     */
    FastMapMatchConfig( int k_arg = 8, double r_arg = 300, double gps_error = 50, double reverse_tolerance = 0.0 );
...
public:
     ...
     * statistics.
     */
    std::string match_gps_file( const FMM::CONFIG::GPSConfig& gps_config, const FMM::CONFIG::ResultConfig& result_config, const FastMapMatchConfig& config, bool use_omp = true );
protected:
    /**
